    ...
    <nav className="fixed top-0 left-0 right-0 z-50 h-[60px] bg-[#0a0a0a] border-b border-[#1e1e1e] flex items-center px-6">
      ...
      <div className="ml-auto flex items-center gap-4 text-sm">
        <Link
          ...
          target="_blank"
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-[#111111] border border-[#1e1e1e] text-[#a1a1aa] hover:text-[#f4f4f5] hover:border-accent/40 transition-colors"
        >
